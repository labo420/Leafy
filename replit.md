...
- **Sistema 5 livelli** (`calculateLevel` in `lib/db` e `LEVEL_CONFIG` in `index.tsx`): Germoglio 🌱 (0–499 pt), Ramoscello 🌿 (500–1499), Arbusto 🍃 (1500–4999), Albero 🌳 (5000–9999), Foresta 🌲 (10000+). I minPts di sblocco livello (frontend) sono: Germoglio=500, Ramoscello=1.500, Arbusto=5.000, Albero=10.000, Foresta=25.000. Ogni livello ha colore tematico, emoji e badge 3D dedicato. La leaderboard è allineata alle stesse soglie.
